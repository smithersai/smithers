...
Supported agent types include `anthropic`, `claude-code`, `openai`, `gemini`, `codex`, and others. See the [TOON Overview](/toon/overview) for details on declaring agents.
