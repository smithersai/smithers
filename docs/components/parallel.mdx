...
| --- | --- | --- | --- |
| `id` | `string` | `undefined` | Optional stable id for tracking and deduping the parallel group. |
...
- `<Parallel>` can be nested inside `<Sequence>`, `<Branch>`, `<Loop>`, or another `<Parallel>`.
