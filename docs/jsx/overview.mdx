...
You can mix normal `<Task>` nodes and MDX prompt components in the same JSX tree.
...
- [Signal](/components/signal) — Wait for a typed external signal and optionally keep unrelated flow moving.
