 ...
 * built from that same copy. `StandardFlows.memory` binds a different
 * `recall`: the bare declaration, filtered by Jev (`JudgedRecallOutput`), so it
 * needs a judge context and applies no policy.
 */
