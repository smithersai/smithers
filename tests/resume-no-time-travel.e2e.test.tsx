...
import { Sequence, Task, Workflow, runWorkflow } from "../src/index";
...
describe("resume without time travel", () => {
  test("resume retries failed task from current state", async () => {
      ...
      const workflow = smithers(() => (
        <Workflow name="resume-current-state">
          <Sequence>
            ...
            <Task id="implement" output={outputs.outputB} agent={makeAgent("implement")}>
              implement the fix
            </Task>
