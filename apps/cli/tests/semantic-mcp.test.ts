...
import {
  createSemanticMcpServer,
} from "../src/mcp/semantic-server";
import { SEMANTIC_TOOL_NAMES } from "../src/mcp/semantic-tools";

const servers: Array<ReturnType<typeof createSemanticMcpServer>> = [];
