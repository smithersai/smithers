...
sidebar:
  order: 7
editUrl: "https://github.com/smithersai/smithers/edit/main/packages/smithers/agent/integrations/docs/guides/x.md"
---

How to use the X adapter. It is **read-only** for now and is library code: no
host in this repository wires it yet. The [API reference](/reference/api/#x) has the
full signatures.
