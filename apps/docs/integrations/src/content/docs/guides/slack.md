...
sidebar:
  order: 4
editUrl: "https://github.com/smithersai/smithers/edit/main/packages/smithers/agent/integrations/docs/guides/slack.md"
---

How to wire one Slack app into a host application. Each section is a recipe;
the [API reference](/reference/api/#slack) has the full signatures.
