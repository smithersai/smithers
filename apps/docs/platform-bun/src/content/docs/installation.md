...
This package vendors no binaries. [`@smthrs/jj`](https://jj.smithers.sh/reference/api/) documents the
...
[The Host surface on Bun](/concepts/host-surface/) for taking one service
