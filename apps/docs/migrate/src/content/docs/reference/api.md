...
| `reservedDirectories`    | `[".flows", ".git", ".jj", "node_modules"]`                                   | Directory names no segment of a layout path may be, at any depth.                                  |
...
| `layoutIssue`                         | `(options) => string \| undefined`                                                                                                                | The root is absolute and normalized; each layout path is a plain relative path (no `.`, `..`, empty segment, NUL, backslash, or trailing slash, and no `.flows`, `.git`, `.jj`, or `node_modules` segment at any depth); the two do not overlap, and flows cannot live under the fixed `.smithers-migrate` lock directory.                 |
...
| `reservedDirectories`                 | `[".flows", ".git", ".jj", "node_modules"]`                                                                                                       | Names no segment of a layout path may be, at any depth.                                                                                                                                                                                                                                                                                    |
