...
The comparison is [`@smthrs/flow`](https://flow.smithers.sh/reference/api/)'s: it holds the graph builder that
...
- [Declare a flow](/guides/declare-a-flow/): where a signature states its
