...
editUrl: "https://github.com/smithersai/smithers/edit/main/packages/smithers/agent/organization/docs/README.md"
---
...
[`example/Org`](https://github.com/smithersai/smithers/blob/main/packages/smithers/agent/organization/example/Org/): `assistant`, `lead`, `builder`, and
`checker`.

## Next

- [Quickstart](/quickstart/): load the example and compose a prompt.
- [Concepts](/concepts/organization/): principals, invariants, lifecycle,
  prompts, and meetings.
- [API reference](/reference/api/): every export.
