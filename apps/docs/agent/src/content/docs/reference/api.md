...
flow from [`@smthrs/std`](https://std.smithers.sh/reference/api/), and one `classify/<id>` flow per curated
...
The one service is the `Evaluator` from [`@smthrs/model`](https://model.smithers.sh/reference/api/). An agent
