...
layer from the [@smthrs/model package](https://model.smithers.sh/reference/api/). The model layer goes
...
- [API reference](/reference/api/): every export of the 20 namespaces.
