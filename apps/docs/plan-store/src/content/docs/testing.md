...
editUrl: "https://github.com/smithersai/smithers/edit/main/packages/smithers/flows/plan-store/docs/testing.md"
---
...
[`@smthrs/database`](https://database.smithers.sh/reference/api/) ships an in-memory SQLite layer for exactly
this, and the drafts come from [`@smthrs/plan`](https://plan.smithers.sh/reference/api/)'s own fixtures so
