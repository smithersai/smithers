...
editUrl: "https://github.com/smithersai/smithers/edit/main/packages/smithers/flows/plan-store/docs/api.md"
---
...
[`@smthrs/keys`](https://keys.smithers.sh/reference/api/), names no database driver, and is browser-safe.
