...
sidebar:
  order: 2
editUrl: "https://github.com/smithersai/smithers/edit/main/packages/smithers/flows/plan-store/docs/quickstart.md"
---
...
[`@smthrs/database`](https://database.smithers.sh/reference/api/) supplies the SQLite client and the durable
...
- [Troubleshooting](/troubleshooting/): every failure message, what causes
