...
export const USER_ONLY_VISIBLE: ReadonlyArray<{ readonly name: string; readonly why: string }> = [
  ...
  { name: "chat.queue.edit", why: "the prompt queue is the human's composer" },
  { name: "chat.queue.remove", why: "the prompt queue is the human's composer" },
  { name: "chat.queue.restore", why: "the prompt queue is the human's composer" },
  { name: "chat.queue.resume", why: "the prompt queue is the human's composer" },
