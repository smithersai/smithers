...
export const APP_TRANSITION_SCHEMAS = {
  ...
  "flow-durations.loaded": z.object({ "type": z.literal("flow-durations.loaded"), "actor": z.literal("system"), "repo": z.string(), "flowId": z.string(), "rows": z.array(z.object({ "actionTag": z.string(), "samples": z.number(), "p50Ms": z.number(), "p90Ms": z.number() }).strict()) }).strict(),
