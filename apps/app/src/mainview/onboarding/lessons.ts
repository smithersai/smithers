...
export const GUIDE_STAGES: readonly GuideLesson[] = [
  ...
  /* 3 */ { kind: "do", practice: true, message: "Let's inspect repro before running it.", completion: "issue.flows.opened", skippable: false,
  ...
  /* 5 */ { kind: "do", practice: true, goal: "plan", message: "Review the plan before the agent changes code.", completion: "plan.ready", skippable: false,
  ...
  /* 9 */ { kind: "do", practice: true, goal: "change", message: "Choose the commits you want to include, then create the Change.", completion: "change.opened", skippable: false,
