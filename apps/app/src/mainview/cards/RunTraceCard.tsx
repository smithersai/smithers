          ...
          <>
            ...
            <div className="run-trace-body">
              ...
              <div className="run-trace-detail">
                ...
                {frame !== undefined ? (
                  <section aria-label="Recorded turn source">
                    {scope.some((span) => span.detail.source !== undefined) ? scope.filter((span) => span.detail.source !== undefined).map((span) => (
                      <Block key={span.id} title="Cell" text={span.detail.source!} />
                    )) : <p>No script source was recorded for this turn.</p>}
                  </section>
                ) : null}
