...
export interface CardProjectionAuthority {
  readonly collections: Pick<AppStore["collections"], "repos" | "starredTargets" | "repositoryNotifications" | "notificationReceipts" | "runtimeRuns" | "runtimeApprovals" | "models"> & Partial<Pick<AppStore["collections"], "cards" | "sessions" | "billingAccounts">>
}
