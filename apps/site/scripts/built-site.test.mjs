...
test("the landing page's Start Here opens the app, through Astro's scoped class names", (t) => {
  ...
  assert.deepEqual(intoDocs, ["index.html: Start Here must open the app at /smithersai/smithers/, got /docs/quickstart/"])
