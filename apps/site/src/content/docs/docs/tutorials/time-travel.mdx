...
```bash
pnpm add @smthrs/flow@next @smthrs/engine@next @smthrs/engine-store@next @smthrs/journal@next @smthrs/time-travel@next @smthrs/flows@next @smthrs/kernel@next @smthrs/run-store@next @smthrs/plan@next @smthrs/platform-node@next effect@4.0.0-rc.115 @effect/platform-node@4.0.0-rc.115 @effect/sql-sqlite-node@4.0.0-rc.115
```
