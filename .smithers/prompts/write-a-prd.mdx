...
What needs to be logged, traced, or monitored to ensure the system is healthy
and debuggable.

### Metrics
Key performance indicators (KPIs) and operational metrics to track success
and performance.

### Verification Strategy
How we will verify this change actually works in production or staging,
including manual testing steps, dry runs, or rollout strategies.
