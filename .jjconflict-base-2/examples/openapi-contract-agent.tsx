...
export default smithers((ctx) => (
  <Workflow name="openapi-contract-agent">
    <Sequence>
      ...
      <Task
        id="generate-interfaces"
        output={outputs.interfaces}
        agent={interfaceGenerator}
      ...
      <Task
        ...
        agent={typedCallBuilder}
        deps={{ contract: outputs.contractSource, interfaces: outputs.interfaces }}
        needs={{ contract: "parse-contract", interfaces: "generate-interfaces" }}
      >
        {(deps) => (
          <TypedCallsPrompt
