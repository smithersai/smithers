...
## Optional: BAML Task Files

If you want to import `.baml` files directly as Smithers tasks, install BAML and register the BAML preload plugin.
...
See [BAML](/integrations/baml) for generator configuration and usage.
