...
const data = [...new Set([...sourceFiles, "factory/wiki/catalog.ts", "flows/wiki/schema.ts", "flows/wiki/evidence.ts", "flows/wiki/workflow.ts", "flows/wiki/operations.ts", "flows/wiki/main.ts", "flows/wiki/runtime.ts", "flows/wiki/reuse.ts", "flows/wiki/jev-citations.ts", "flows/repository/jev-checks.ts", "flows/coding/schema.ts", "flows/release-support/runtime.ts"])].map((file) => S.file(`//${file}`))
