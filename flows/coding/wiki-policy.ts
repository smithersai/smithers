...
const sources = [
  "../wiki/flow.ts", "../wiki/workflow.ts", "../wiki/schema.ts", "../wiki/evidence.ts", "../wiki/runtime.ts",
  "../wiki/operations.ts", "../wiki/reuse.ts", "../wiki/jev-citations.ts", "./host.ts", "./planning-wiki.ts",
