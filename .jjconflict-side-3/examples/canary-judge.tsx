  ...
  <Workflow name="canary-judge">
    <Sequence>
      ...
      <Task
        ...
        agent={comparator}
        deps={{ stable: outputs.telemetry, canary: outputs.telemetry }}
        needs={{ stable: "collect-stable", canary: "collect-canary" }}
      >
        {(deps) => (
          <ComparePrompt
            stable={deps.stable}
      ...
      <Task id="judge" output={outputs.verdict} agent={judge} deps={{ compare: outputs.comparison }}>
        {(deps) => (
          <JudgePrompt
            comparison={deps.compare}
            riskSignals={deps.compare.riskSignals}
