...
describe("explicit public entrypoints", () => {
  ...
  it("admits only explicitly reviewed additions without rewriting the original surface", () => {
    assert.deepEqual(baseline.added.map(({ name, subpath }) => `${name}${subpath.slice(1)}`).sort(), [
      "@smthrs/agent/ScriptedJudge", "@smthrs/agent/SeatRouter", "@smthrs/agent/SmithersPlugin", "@smthrs/artifacts/FileLease", "@smthrs/build-cli/TargetIndex", "@smthrs/canonical/BoundedJson", "@smthrs/canonical/IssuePath", "@smthrs/canonical/ReadonlyMap", "@smthrs/canonical/Record", "@smthrs/canonical/Serializer", "@smthrs/cli/BunControl", "@smthrs/control/ApprovalAuthority", "@smthrs/control/DispatchReader", "@smthrs/control/Health", "@smthrs/create-app/worker", "@smthrs/crypto/Identity", "@smthrs/database/bun/BunDatabase", "@smthrs/engine-store/EventTypes", "@smthrs/engine-store/ExecutionSnapshot", "@smthrs/engine-store/PlanInputStore", "@smthrs/engine-store/PlanMergeStore", "@smthrs/engine-store/RunChangeFeed", "@smthrs/flow/Stall", "@smthrs/flows/BunRuntime", "@smthrs/flows/Runtime", "@smthrs/gateway/EngineTrace", "@smthrs/gateway/RunTrace", "@smthrs/gateway/RuntimeBridge", "@smthrs/gateway/bun/BunGateway", "@smthrs/harness/CompletionClaim", "@smthrs/harness/FailedCall", "@smthrs/harness/Judgement", "@smthrs/harness/Monitor", "@smthrs/harness/Relevance", "@smthrs/harness/Supervisor", "@smthrs/integrations/core/AccessToken", "@smthrs/integrations/core/Connection", "@smthrs/integrations/core/OAuthToken", "@smthrs/integrations/core/Source", "@smthrs/integrations/core/SourceRecord", "@smthrs/integrations/core/SourceStore", "@smthrs/integrations/core/Sync", "@smthrs/integrations/github/Sync", "@smthrs/integrations/gmail", "@smthrs/integrations/gmail/Actions", "@smthrs/integrations/gmail/Capabilities", "@smthrs/integrations/gmail/Config", "@smthrs/integrations/gmail/GmailClient", "@smthrs/integrations/gmail/Mime", "@smthrs/integrations/gmail/Reconcile", "@smthrs/integrations/gmail/Records", "@smthrs/integrations/gmail/Sync", "@smthrs/integrations/googlecalendar", "@smthrs/integrations/googlecalendar/Actions", "@smthrs/integrations/googlecalendar/CalendarClient", "@smthrs/integrations/googlecalendar/Config", "@smthrs/integrations/googlecalendar/Event", "@smthrs/integrations/googlecalendar/EventId", "@smthrs/integrations/googlecalendar/Sync", "@smthrs/integrations/slack", "@smthrs/integrations/slack/Actions", "@smthrs/integrations/slack/Approval", "@smthrs/integrations/slack/Config", "@smthrs/integrations/slack/Connections", "@smthrs/integrations/slack/Payload", "@smthrs/integrations/slack/SlackClient", "@smthrs/integrations/slack/SocketSource", "@smthrs/integrations/slack/Sync", "@smthrs/integrations/slack/Webhook", "@smthrs/integrations/x", "@smthrs/integrations/x/Capabilities", "@smthrs/integrations/x/Config", "@smthrs/integrations/x/Records", "@smthrs/integrations/x/Sync", "@smthrs/integrations/x/XClient", "@smthrs/journal/EngineEvent", "@smthrs/journal/JournalGeneration", "@smthrs/kernel/ChildProcessEnvironment", "@smthrs/memory/Migrations", "@smthrs/model/Classifier", "@smthrs/model/Evaluator", "@smthrs/model/FailureCopy", "@smthrs/model/ModelCatalog", "@smthrs/plan/CachePolicy", "@smthrs/plan/Effects", "@smthrs/plan/Placement", "@smthrs/plan/Repetition", "@smthrs/plan/Scheduling", "@smthrs/plan/test/PlanFixtures", "@smthrs/platform-node/EgressHttpClient", "@smthrs/platform-node/ScopedProcess", "@smthrs/scorers/ScoreGate", "@smthrs/std/Relocate", "@smthrs/std/TreeFingerprint", "@smthrs/testing/ProcessTable", "@smthrs/triggers/DispatchReader"
    ])
