...
manifests declare `engines.node` as `>=26.4.0`, and the release workflow
runs the candidate tarballs on `26.4.0`. That floor is the Node the published packages support, and it is a
