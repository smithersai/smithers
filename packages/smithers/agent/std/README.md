...
| -------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------ |
| `ApplyPatch`         | `name`, `description`, `Input`, `Output`, `effects`, `effectsFor`, `capabilities`, `flow`, `run`, `activity`, `presentation`                                                                                                                             | Declares and applies a V4A patch.                                              |
| `Bash`               | `name`, `description`, `DEFAULT_TIMEOUT_MS`, `Input`, `Output`, `effects`, `effectsFor`, `capabilities`, `flow`, `run`, `presentation`                                                                                                                   | Declares and runs bounded shell commands.                                      |
...
| `Classifiers`        | `relevance`, `checkVerdict`, `probeAttribution`, `editRisk`, `all`                                                                                                                                                                                       | The three curated classifiers, and the one the `test` flow asks itself.        |
| `Classify`           | `name`, `description`, `MAX_STATES`, `MAX_STATE_BYTES`, `CONCURRENCY`, `State`, `Questions`, `States`, `Input`, `Verdict`, `BatchResult`, `Output`, `effects`, `effectsFor`, `capabilities`, `flow`, `ask`, `askAll`, `run`, `answerContract`, `curated` | Declares and runs typed Jev questions over JSON state, ad hoc or curated.      |
...
| `Edit`               | `name`, `description`, `Input`, `Output`, `effects`, `effectsFor`, `capabilities`, `flow`, `run`, `activity`, `presentation`                                                                                                                             | Declares and applies exact text replacements.                                  |
...
| `Glob`               | `name`, `description`, `Input`, `Output`, `effects`, `effectsFor`, `capabilities`, `flow`, `run`, `activity`, `presentation`                                                                                                                             | Declares and runs filesystem glob searches.                                    |
| `Grep`               | `name`, `description`, `Input`, `ContextLine`, `Symbol`, `Match`, `Output`, `effects`, `effectsFor`, `capabilities`, `flow`, `run`, `activity`, `presentation`                                                                                           | Declares and runs text searches over files.                                    |
...
| `Ls`                 | `name`, `description`, `Input`, `Output`, `effects`, `effectsFor`, `capabilities`, `flow`, `run`, `activity`, `presentation`                                                                                                                             | Declares and runs directory listings.                                          |
...
| `Probe`              | `key`, `Reason`, `InvalidProbe`, `Attribution`, `CONFIDENCE_FLOOR`, `MAX_OUTPUT_BYTES`, `posix`, `classify`, `unjudged`                                                                                                                                  | Attributes a non-zero exit to the command or to the tree, with Jev.            |
...
| `TestRun`            | `name`, `description`, `scratchDirectory`, `DEFAULT_TIMEOUT_MS`, `MAX_CAPTURE_BYTES`, `Input`, `Outcome`, `Output`, `effects`, `effectsFor`, `capabilities`, `flow`, `run`, `activity`, `presentation`                                                   | Runs the declared test suite and reads its report.                             |
...
| `Write`              | `name`, `description`, `Input`, `Output`, `effects`, `effectsFor`, `capabilities`, `flow`, `run`, `activity`, `presentation`                                                                                                                             | Declares and runs file writes.                                                 |
...
| `Classify.MAX_STATES`                     | 64          | states in one `classify` call                                   |
| `Classify.MAX_STATE_BYTES`                | 32,768      | one `classify` state as JSON                                    |
| `Classify.CONCURRENCY`                    | 8           | states of one `classify` batch in flight at once                |
