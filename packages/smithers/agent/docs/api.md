...
| `fallbackSeats`      | `ReadonlyArray<Seat.Seat>`                                     | Resolved seats tried in order after a capacity refusal. Rate limits cool the refused model on its route; explicit account quota and HTTP 529 cool the whole route.                                                                                                                                                                      |
...
[`@smthrs/memory`](/api/memory). Without a `scope`, a call reaches any bank it
