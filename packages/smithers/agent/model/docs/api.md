...
| Export                                | Kind        | Behavior                                                                                                                                                                                                                                                                                                                                                                                |
| ------------------------------------- | ----------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `Protocol<Body, Frame, Event, State>` | interface   | `{ id, supportsDeferred, body, stream, classifyError, headers? }`. `headers(request)`, when present, returns public headers derived from one request, merged over the route's static headers and sealed into the step key like the body. `supportsDeferred(modelId)` reports native deferred-tool support. `classifyError(status, body)` maps a failed HTTP response to a `ModelError`. |
