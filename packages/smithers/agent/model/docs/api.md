...
| `chatgptProtocol` | protocol  | Id `openai-responses-chatgpt`. The same SSE stream and usage counters, with reasoning continuation carried in `encrypted_content`. Native deferred tools only for the GPT-6 ids probed live on this backend (2026-09-24). |
