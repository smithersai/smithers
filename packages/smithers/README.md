...
| `serve`                                                                | Host the control gateway.                                                 |
...
| `BunControl`        | `layerControl`, `layerRegistry`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | Composes the native Control host with Bun adapters, loaded when the layer is built.                                                                                          |
...
| `Detached`          | `admissionVariable`, `defaultTimeoutMs`, `defaultTerminationGraceMs`, `admissionLine`, `admittedRunId`, `announcedRunIds`, `logTail`, `terminate`, `Launched`, `Rejected`, `Options`, `launch`, `discard`, `isLaunched`                                                                                                                                                                                                                                                                                                                                                                                                                                               | Launches `up -d`, and reads the admission line its child prints.                                                                                                             |
...
| `Gc`                | `defaultRetention`, `objectsDirectory`, `duration`, `databases`, `Failure`, `Sweep`, `sweep`, `failureMessage`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | The retention pass over a project's databases, and what it could not open.                                                                                                   |
...
| `NodeControl`       | `Environment`, `ServerOptions`, `makeConfig`, `config`, `configFromArguments`, `projectSources`, `layerHostPlatform`, `layerGrantStore`, `layerGuardedPlatform`, `layerObserver`, `layerRegistry`, `databasePath`, `executionDatabasePath`, `EngineDurable`, `engineDurable`, `seatResolver`, `layerSeatResolver`, `testRunner`, `checkpointStore`, `evaluator`, `testFlows`, `environmentDispatcher`, `layerEgressHttpClient`, `layerRebuildableRequestExecutor`, `rebuildableTransport`, `layerExecutor`, `layerControl`, `layerOutput`, `layer`, `layerMemoryRemote`, `layerMemory`, `layerServer`, `layerGateway`, `layerServerBearerAuth`, `layerServerNoopAuth` | Assembles Node configuration, Control, the run executor, output, and the served gateway.                                                                                     |
...
| `Providers`         | `order`, `compatible`, `compatibleKey`, `defaultSeat`, `seatAliases`, `decisionSeat`, `expandSeat`, `isDecisionSeat`, `seatRefusal`, `starterSeats`, `detect`, `NoSeatError`, `SeatSyntaxError`, `noSeatMessage`, `chooseSeat`                                                                                                                                                                                                                                                                                                                                                                                                                                        | Which model seats this machine can run `smthrs suggest` on, and which one it runs.                                                                                           |
...
| `Ui`                | `brand`, `cleanupTimeoutMillis`, `Check`, `Spinner`, `StreamOptions`, `Streamed`, `PickOptions`, `ConfirmOptions`, `Service`, `Ui`, `Options`, `isInteractive`, `make`, `renderChecklist`, `levelWord`, `layer`, `current`, `prompting`                                                                                                                                                                                                                                                                                                                                                                                                                               | Interactive human rendering: brand line, log lines, spinners, streamed suggestions, prompts, and the plain-line fallback.                                                    |
...
| `Verb`              | `Verb`, `shipped`, `subcommands`, `names`, `find`, `select`, `startsRuns`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | The shipped verb catalog, lookup, and which verbs can start or resume a run.                                                                                                 |
