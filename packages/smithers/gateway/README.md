...
| `GatewayProjection`         | `RunSummaryRow`, `RunTreeRow`, `ApprovalRow`, `NodeOutputRow`, `TranscriptRow`, `runSummary`, `statusRollup`, `runTree`, `approvals`, `nodeOutput`, `transcript`                                                                                                                                                                                                                                                         | Defines the served wire rows and the pure folds that compute them.                                           |
...
| `Projections`               | `heartbeatIntervalMillis`, `maxWorkspaceRuns`, `maxEventsPerRun`, `maxEventsScanned`, `maxEventsPerPage`, `maxProjectionBytes`, `maxEventBytes`, `Service`, `Projections`, `make`, `layer`, `layerWith`                                                                                                                                                                                                                  | Serves the bounded read path as snapshots and followed deltas.                                               |
