...
| `Diagnosis`                 | `RunStatus`, `Refusal`, `Digest`, `asRecord`, `asString`, `asNumber`, `timeOf`, `firstLine`, `clip`, `digest`, `emptyDigest`, `combine`, `duration`, `verdict`, `Subject`, `render`, `callEventKey`, `nativeCallEvent`, `openCallIndex`, `uniqueCallEvents`                                                                                                                                                              | Computes and renders what happened to a run, from that run's own control events.                             |
