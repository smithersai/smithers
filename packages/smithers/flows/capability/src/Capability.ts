...
/** The glob metacharacters. Every other code unit in a resource is literal. */
 ...
 *
 * That asymmetry is the opposite of {@link subsumes} and is the point. A
 * caller asks {@link subsumes} before widening a grant, so an unprovable
