...
crossed. A frame whose anchor recorded no operation refuses it with
`irreversible`, and a repository whose other workspaces changed after the
operation refuses it with `compensation_failed`.
