...
| `dots`, `colorOf`, `strip`, `dotted`, `retitle`                                        | title helpers                                                       | The dot per color, and how a title carries, loses, and keeps one across a rename; `strip` drops the U+FE0F the app writes after the dot, and an empty rename keeps the title. |
