...
import { SetupHostInputSchema, setupCandidate } from "../src/RepositorySetup.ts"

describe("shared Go setup admission fixture", () => {
  it("uses the canonical draft schema and exact candidate digest", () => {
    const fixtures = JSON.parse(readFileSync(new URL("../testdata/repository-setup-backend.json", import.meta.url), "utf8"))
