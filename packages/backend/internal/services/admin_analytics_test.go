...
func TestAdminAnalyticsServiceInitiatorCancellationKeepsSharedQuery(t *testing.T) {
	...
	require.Equal(t, 19, calls, "waiter and cached request reuse one query batch")
}
