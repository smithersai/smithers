...
func TestRunner_Z_CompleteTaskBranches(t *testing.T) {
	...
	checks := &mockRunnerCheckRunService{
		updateFn: func(context.Context, int64, string, string, int64, GitHubCheckRunUpdate) (GitHubCheckRunResult, error) {
			return GitHubCheckRunResult{}, boom
		},
	}
...
func TestRunner_Z_CheckRunAnnotationHelpers(t *testing.T) {
	...
	require.Equal(t, "Workflow failed", workflowRunStatusDescription("failure"))
...
func TestRunner_Z_DispatchBranches(t *testing.T) {
	...
	}, workflowDispatcher: &mockRunnerWorkflowDispatcher{dispatchFn: func(context.Context, DispatchForEventInput) ([]WorkflowRunResult, error) {
		return nil, boom
