...
func (d *alertRemediationWorkerCovDispatcher) DispatchForEvent(_ context.Context, input services.DispatchForEventInput) ([]services.WorkflowRunResult, error) {
	d.calls++
	d.input = input
	...
	return []services.WorkflowRunResult{{WorkflowRunID: 99, WorkflowDefinitionID: definitionID}}, d.err
}
