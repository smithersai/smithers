...
func buildRouter(
	...
	gateAgents := middleware.FeatureFlagGate(func() bool { return cfg.FeatureFlags.Agents })
	gateWorkspaces := middleware.FeatureFlagGate(func() bool { return cfg.FeatureFlags.Workspaces })
