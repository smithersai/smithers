...
PRIVATE_MIGRATION_TABLES = {"atlas_schema_revisions"}
...
def product_drift(expected: dict, actual: dict) -> list[dict[str, str]]:
...
def adopt(url: str, checksum: str) -> None:
